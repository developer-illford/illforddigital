...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var swiper = new Swiper('.mil-blog-slider', {
        ...
        // centeredSlides: true,
        speed: 800,
        loop: false, // Disable loop to manually control transition.
        ...
        on: {
            slideChange: function () {
                if (this.activeIndex === 21) { // When reaching the 10th slide
                    setTimeout(() => {
                        this.slideTo(1, 1); // Instantly jump to 1st slide without transition
                    }, 800); // Wait for the transition effect, then switch
                }
            },
    ...
    // Small screen Swiper
    var swiperSm = new Swiper('.mil-blog-slider-sm', {
        parallax: true,
        autoHeight: true,
        spaceBetween: 30,
        slidesPerView: 1,
...
// Select all the popup close buttons
document.querySelectorAll('.popup_close_button').forEach(button => {
    button.addEventListener('click', function () {
        // Find the parent element of the clicked button
        const parent = this.parentElement;

        // Change the display property of the parent element
        if (parent) {
...
// Define your class combinations
const classCombinations = [
    { clickClass: 'graphic_design', targetClass: 'portfolio_popup_graphic_design' },
    { clickClass: 'vedio_marketing', targetClass: 'portfolio_popup_vedio_marketing' },
    { clickClass: 'digital_branding', targetClass: 'portfolio_popup_digital_branding' },
    { clickClass: 'business_marketing', targetClass: 'portfolio_popup_business_marketing' },
    { clickClass: 'uiux', targetClass: 'portfolio_popup_uiux' },
    { clickClass: 'web_development', targetClass: 'portfolio_popup_web_development' },
    { clickClass: 'content_development', targetClass: 'portfolio_popup_content_development' },
    { clickClass: 'advertising_management', targetClass: 'portfolio_popup_advertising_management' },
];

// Set up event listeners for each class combination
classCombinations.forEach(combo => {
    setupClickToShow(combo.clickClass, combo.targetClass);
});


function setupClickToShow(clickClass, targetClass) {
    // Select all elements with the clickClass
    document.querySelectorAll(`.${clickClass}`).forEach(clickableElement => {
        clickableElement.addEventListener('click', function () {
            // Select all elements with the targetClass
